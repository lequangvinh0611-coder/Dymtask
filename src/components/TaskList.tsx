        ...
        <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
          <div className="relative flex-shrink-0">
            ...
            <select 
              ...
              className="px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg text-[10px] h-8 min-w-[100px] font-black text-slate-600 focus:ring-2 focus:ring-indigo-500/10 focus:outline-none cursor-pointer text-center uppercase tracking-widest" 
